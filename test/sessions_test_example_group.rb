...
result.update_test_result_example_group( session_id: "#{session_id}",
...
init_result=init_session.get_session_info_by_id("#{session_id}")
init_result.update_test_result( session_id: "#{session_id}",
													 test_result_status: 'passed',
													 reason: 'passed reason')
