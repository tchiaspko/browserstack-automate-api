...
build_id=session.get_build_id(session_id: "#{SESSION_ID}")
...
puts "Session: Test get_build_id (it should return the build id from a session id )"
session=Browserstack::Automate::Sessions.new
build_id=session.get_build_id(session_id: "#{SESSION_ID2}")
...
print "build_url=",   session.get_browserstack_build_url(session_id:   "#{SESSION_ID2}")
print "\n\n"
print "session_url=", session.get_browserstack_session_url(session_id: "#{SESSION_ID2}")
print "\n\n"
